...
///自定义Dialog
class YaCustomDialog extends StatefulWidget {
  ...
  const YaCustomDialog({Key key, this.title, this.content, this.confirmContent, this.confirmTextColor, this.isCancel = true, this.confirmColor, this.cancelColor, this.outsideDismiss = true, this.confirmCallback, this.dismissCallback, this.image, this.imageHintText}) : super(key: key);
...
class _CustomDialogState extends State<YaCustomDialog> {
